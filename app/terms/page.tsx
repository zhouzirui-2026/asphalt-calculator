...
export default function TermsPage() {
  return <SiteShell currentPath="/terms"><main className="page-main prose-page shell">
    ...
    <header className="prose-header"><p className="eyebrow">Terms</p><h1>Terms of use</h1><p>Use the calculators as transparent planning aids, not as engineering documents or bids.</p><div className="byline"><span>Effective August 18, 2026</span><span>Last reviewed August 18, 2026</span></div></header>
