...
export default function AboutPage() {
  return <SiteShell currentPath="/about"><main className="page-main prose-page shell">
    ...
    <section><h2>Editorial and correction policy</h2><p>Factual defaults must be linked to an authoritative source and remain editable. Formulas are unit tested. A correction should update the source note, calculator implementation when relevant, tests, visible explanation, and review date together.</p><p>To report a correction or ask a support question, email <a href="mailto:support@asphalt-calculator.top">support@asphalt-calculator.top</a>. The calculator never sends your project inputs to this address automatically. Please read the <Link href="/privacy">privacy policy</Link> before including personal information in a message.</p></section>
