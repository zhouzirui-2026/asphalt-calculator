...
export default function PrivacyPage() {
  return <SiteShell currentPath="/privacy"><main className="page-main prose-page shell">
    ...
    <header className="prose-header"><p className="eyebrow">Privacy</p><h1>Privacy policy</h1><p>You can use every calculator without providing personal information.</p><div className="byline"><span>Effective August 20, 2026</span><span>Last reviewed August 20, 2026</span></div></header>
    ...
    <section><h2>Accounts, payments, and advertising</h2><p>The site has no account system, payment service, contact form, remote application database, outbound email service, or advertising script. The analytics preference itself is stored in your browser&apos;s local storage.</p></section>
